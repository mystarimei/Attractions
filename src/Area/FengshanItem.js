...
const FengshanItem = (props) => {
    const {
        FengshanAttraction: { id, title, photo, likeCount, unlikeCount, posterName, avatar, publish,posterId },
        handleToAttractionDetail, handleLike, handleUnLike, handleEdit
    } = props;
    return (
