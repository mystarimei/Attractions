...
import { View, Text, ScrollView, Image, StyleSheet, Dimensions, TouchableOpacity, ImagePropTypes } from 'react-native'
...
const TianliaoItem = (props) => {
    const {
        TianliaoAttraction: { id, title, photo, likeCount, unlikeCount, posterName, avatar, publish, posterId },
        handleToAttractionDetail, handleLike, handleUnLike, handleDelete, handleEdit
    } = props;
    return (
        <TouchableOpacity onLongPress={() => handleEdit(id, posterId)}>
            <View style={{ flexDirection: 'row', paddingHorizontal: 7, paddingVertical: 3, borderBottomWidth: 2, borderBottomColor: '#d3d3d3', }}>
                ...
                <View style={{ flex: 0.35, justifyContent: 'space-around' }}>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <Image style={{ width: 70, height: 70, borderRadius: 100 }} source={likeType(likeCount, unlikeCount)} />
                    </View>
